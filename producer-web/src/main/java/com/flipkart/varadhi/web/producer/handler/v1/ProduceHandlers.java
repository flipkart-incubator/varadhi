...
public class ProduceHandlers implements RouteProvider {
    ...
    private int getHttpStatusForProduceStatus(ProduceStatus produceStatus) {
        return switch (produceStatus) {
            case ProduceStatus.Blocked, ProduceStatus.NotAllowed -> HttpCodes.HTTP_UNPROCESSABLE_ENTITY;
            case ProduceStatus.Throttled -> HttpCodes.HTTP_RATE_LIMITED;
            case ProduceStatus.Failed -> HTTP_INTERNAL_ERROR;
            default -> {
