...
public class TeamServiceTest {
    ...
    public void testListTeam() {
        ...
        Assertions.assertEquals(org1Team1, org1Teams.getFirst());
        List<Team> org2Teams = teamService.getTeams(org2Team1.getOrg());
        Assertions.assertEquals(1, org2Teams.size());
        Assertions.assertEquals(org2Team1, org2Teams.getFirst());
    ...
    public void testGetProjects() {
        ...
        Assertions.assertEquals(p1, projects.getFirst());
    ...
    private void validateOrgNotFound(Team team, MethodCaller caller) {
        ResourceNotFoundException eResource = Assertions.assertThrows(ResourceNotFoundException.class, caller::call);
