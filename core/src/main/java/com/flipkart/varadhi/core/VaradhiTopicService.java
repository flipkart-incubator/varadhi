...
public class VaradhiTopicService {
     ...
     */
    public void handleSoftDelete(VaradhiTopic varadhiTopic, RequestActionType actionRequest) {
    ...
    public void restore(String topicName, RequestActionType actionRequest) {
        ...
        varadhiTopic.restore(actionRequest.actionCode(), actionRequest.message());
        topicStore.update(varadhiTopic);
    }
