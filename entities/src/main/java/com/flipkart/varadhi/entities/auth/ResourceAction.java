...
public enum ResourceAction {
     ...
     */
    ORG_CREATE(ResourceType.ORG, Action.CREATE),
    ORG_UPDATE(ResourceType.ORG, Action.UPDATE),
    ORG_DELETE(ResourceType.ORG, Action.DELETE),
    ORG_GET(ResourceType.ORG, Action.GET),
    ORG_LIST(ResourceType.ROOT, Action.LIST),
    ORG_PROJECT_MIGRATE(ResourceType.ORG, Action.MIGRATE),

    /**
     * Actions related to team resources.
     */
    TEAM_CREATE(ResourceType.TEAM, Action.CREATE),
    TEAM_UPDATE(ResourceType.TEAM, Action.UPDATE),
    TEAM_DELETE(ResourceType.TEAM, Action.DELETE),
    TEAM_GET(ResourceType.TEAM, Action.GET),
    TEAM_LIST(ResourceType.ORG, Action.LIST),

    /**
     * Actions related to project resources.
     */
    PROJECT_CREATE(ResourceType.PROJECT, Action.CREATE),
    PROJECT_UPDATE(ResourceType.PROJECT, Action.UPDATE),
    PROJECT_DELETE(ResourceType.PROJECT, Action.DELETE),
    PROJECT_GET(ResourceType.PROJECT, Action.GET),
    PROJECT_LIST(ResourceType.TEAM, Action.LIST),

    /**
     * Actions related to topic resources.
     */
    TOPIC_CREATE(ResourceType.TOPIC, Action.CREATE),
    TOPIC_UPDATE(ResourceType.TOPIC, Action.UPDATE),
    ...
    TOPIC_SUBSCRIBE(ResourceType.TOPIC, Action.SUBSCRIBE),
    TOPIC_PRODUCE(ResourceType.TOPIC, Action.PRODUCE),

    /**
     * Actions related to subscription resources.
     */
    SUBSCRIPTION_CREATE(ResourceType.SUBSCRIPTION, Action.CREATE),
    SUBSCRIPTION_UPDATE(ResourceType.SUBSCRIPTION, Action.UPDATE),
     ...
     */
    IAM_POLICY_GET(ResourceType.IAM_POLICY, Action.GET),
    IAM_POLICY_SET(ResourceType.IAM_POLICY, Action.SET),
