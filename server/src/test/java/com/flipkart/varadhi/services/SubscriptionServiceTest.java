...
class SubscriptionServiceTest {
    ...
    private void setupInfrastructure() throws Exception {
        ...
        topicOperations = spy(varadhiMetaStore.topicOperations());
        subscriptionOperations = spy(varadhiMetaStore.subscriptionOperations());
        orgOperations = spy(varadhiMetaStore.orgOperations());
        teamOperations = spy(varadhiMetaStore.teamOperations());
        projectOperations = spy(varadhiMetaStore.projectOperations());
    ...
    void getSubscriptionList_MetaStoreFailure_ThrowsException() {
        ...
        when(subscriptionOperations.getSubscriptionNames(projectName)).thenThrow(
        ...
        verify(subscriptionOperations, times(1)).getSubscriptionNames(projectName);
    }
    ...
    void getSubscriptionList_InactiveSubscriptionsAreFilteredOut() {
        ...
        subscriptionOperations.updateSubscription(subscription2);

        when(subscriptionOperations.getSubscriptionNames(project1.getName())).thenReturn(
                List.of(subscription1.getName(), subscription2.getName())
        );
        when(subscriptionOperations.getSubscription(subscription1.getName())).thenReturn(subscription1);
        when(subscriptionOperations.getSubscription(subscription2.getName())).thenReturn(subscription2);
        ...
        verify(subscriptionOperations, times(1)).getSubscriptionNames(project1.getName());
        verify(subscriptionOperations, times(1)).getSubscription(subscription1.getName());
        verify(subscriptionOperations, times(1)).getSubscription(subscription2.getName());
    }
    ...
    void getSubscription_InactiveSubscription_ReturnsCorrectSubscription() {
        ...
        subscriptionOperations.updateSubscription(subscription1);
    ...
    void getSubscription_MetaStoreFailure_ThrowsException() {
        String subscriptionName = subscription1.getName();
        doThrow(new RuntimeException("MetaStore retrieval failed")).when(subscriptionOperations)
        ...
        verify(subscriptionOperations, times(1)).getSubscription(subscriptionName);
    }
    ...
    void createSubscription_ValidUngroupedTopic_CreatesSuccessfully() {
        ...
        verify(subscriptionOperations, times(1)).createSubscription(subscription1);
    }
    ...
    void createSubscription_MetaStoreFailure_ThrowsException() {
        doReturn(unGroupedTopic).when(topicOperations).getTopic(unGroupedTopic.getName());
        doThrow(new RuntimeException("MetaStore creation failed")).when(subscriptionOperations).createSubscription(any());
    ...
    void updateSubscription_MetaStoreFailure_ThrowsRuntimeException() {
        ...
        doThrow(new RuntimeException("MetaStore update failed")).when(subscriptionOperations).updateSubscription(any());
        ...
        verify(subscriptionOperations, times(2)).updateSubscription(subscriptionCaptor.capture());
    ...
    void deleteSubscription_SoftDelete_UpdatesSubscriptionState() {
        ...
        verify(subscriptionOperations, times(1)).updateSubscription(subscription1);
        VaradhiSubscription updatedSubscription = subscriptionOperations.getSubscription(subscription1.getName());
    ...
    void deleteSubscription_ResourceNotStopped_ThrowsException() {
        ...
        verify(subscriptionOperations, never()).deleteSubscription(subscription1.getName());
    }
    ...
    void deleteSubscription_MetaStoreFailure_ThrowsException() {
        ...
        doReturn(stoppedState).when(controllerRestApi).getSubscriptionState(subscription1.getName(), REQUESTED_BY);
        doThrow(new RuntimeException("MetaStore deletion failed")).when(subscriptionOperations)
        ...
        verify(subscriptionOperations, times(1)).deleteSubscription(subscription1.getName());
    }
    ...
    void restoreSubscription_Success() {
        ...
        verify(subscriptionOperations, times(2)).updateSubscription(subscription1);
    }
