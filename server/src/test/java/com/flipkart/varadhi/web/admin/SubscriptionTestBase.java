...
public class SubscriptionTestBase extends WebTestBase {
    ...
    private static final Map<String, String> DEFAULT_SUBSCRIPTION_PROPERTIES =
    ...
    protected SubscriptionResource createSubscriptionResource(
            String subscriptionName, Project project, TopicResource topic, RetryPolicy retryPolicy
    ) {
