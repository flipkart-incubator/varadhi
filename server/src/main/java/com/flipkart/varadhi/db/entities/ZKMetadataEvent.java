...
public class ZKMetadataEvent implements MetaStoreChangeEvent {
     ...
     * @param entityType the type of the resource that was modified
     * @param zkMetaStore  the ZooKeeper metadata store instance
     */
    public ZKMetadataEvent(String path, String resourceName, EntityType entityType, ZKMetaStore zkMetaStore) {
        this.path = Objects.requireNonNull(path, "path cannot be null.");
        this.resourceName = Objects.requireNonNull(resourceName, "resourceName cannot be null.");
        this.entityType = Objects.requireNonNull(entityType, "resourceType cannot be null.");
