...
/**
 * Main application configuration class that holds all configuration options.
 * <p>
 * This class provides a centralized way to manage all configuration parameters
 * required by different components of the application. It supports validation
 * and proper initialization of all configuration options.
 */
@Getter
public class AppConfiguration implements Validatable {
    ...
    /**
     * Refer Vertx DeliveryOptions for details, used for internode communication.
