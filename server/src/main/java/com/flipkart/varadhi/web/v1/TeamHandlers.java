...
public class TeamHandlers implements RouteProvider {
    ...
    public List<RouteDefinition> get() {
        return new SubRoutes(
                ...
                List.of(
                        new RouteDefinition(
                                HttpMethod.GET, "", Set.of(authenticated), this::listTeams,
                                Optional.of(PermissionAuthorization.of(TEAM_GET, "{org}"))
                        ),
                        new RouteDefinition(
                                HttpMethod.GET, "/:team/projects", Set.of(authenticated), this::listProjects,
                                Optional.of(PermissionAuthorization.of(TEAM_GET, "{org}"))
                        ),
                        new RouteDefinition(
                                HttpMethod.GET, "/:team", Set.of(authenticated), this::get,
                        ...
                        new RouteDefinition(
                                HttpMethod.DELETE, "/:team", Set.of(authenticated), this::delete,
