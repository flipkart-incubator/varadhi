...
public class TeamHandlers implements RouteProvider {
    ...
    public List<RouteDefinition> get() {
        return new SubRoutes(
                ...
                List.of(
                        new RouteDefinition(
                                HttpMethod.GET, "", Set.of(authenticated), Sets.newLinkedHashSet(), this::listTeams,
                                true,
                                Optional.of(PermissionAuthorization.of(TEAM_GET, "{org}"))
                        ),
                        new RouteDefinition(
                                HttpMethod.GET, "/:team/projects", Set.of(authenticated), Sets.newLinkedHashSet(),
                                this::listProjects, true,
                                Optional.of(PermissionAuthorization.of(TEAM_GET, "{org}"))
                        ),
                        new RouteDefinition(
                                HttpMethod.GET, "/:team", Set.of(authenticated), Sets.newLinkedHashSet(), this::get,
                                true,
                        ...
                        new RouteDefinition(
                                HttpMethod.DELETE, "/:team", Set.of(authenticated), Sets.newLinkedHashSet(),
                                this::delete, true,
